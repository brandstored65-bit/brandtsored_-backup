...
export const promotionalTemplates = [
      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          <div style="text-align: center; margin-top: 32px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%); color: #ffffff; padding: 16px 48px; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 16px; box-shadow: 0 8px 20px rgba(139, 92, 246, 0.4); border: 2px solid #8b5cf6; letter-spacing: 0.5px; transition: all 0.3s ease;">
              🚀 START SHOPPING NOW 🚀
            </a>
            <p style="font-size: 12px; color: #6b7280; margin-top: 12px;">Limited time offer • Free shipping on orders over AED500</p>
          </div>
        </div>
  ...
  {
    id: 'trending-now',
    subject: 'Trending Now on Brandstored 🔥',
    title: 'Trending Now',
    subtitle: 'on Brandstored',
    emoji: '🔥',
    color: '#ec4899',
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        <div style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); padding: 40px 20px; text-align: center; color: #ffffff;">
          ...
          <p style="margin: 10px 0 0 0; font-size: 18px; opacity: 0.95;">on Brandstored</p>
        </div>
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #ec4899; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(236, 72, 153, 0.3);">
              See Trending
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #f43f5e; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(244, 63, 94, 0.3);">
              Check Wishlist
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #dc2626; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(220, 38, 38, 0.3);">
              Shop Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #06b6d4; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(6, 182, 212, 0.3);">
              Discover Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #ea580c; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.3);">
              Grab Deals
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #3b82f6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(59, 130, 246, 0.3);">
              Shop Smart
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #10b981; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.3);">
              View Popular
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #7c3aed; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(124, 58, 237, 0.3);">
              Save Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #0d9488; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(13, 148, 136, 0.3);">
              Shop Essentials
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #f97316; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(249, 115, 22, 0.3);">
              Shop Now
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #8b5cf6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(139, 92, 246, 0.3);">
              Start Shopping
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #14b8a6; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(20, 184, 166, 0.3);">
              Explore Deals
            </a>
          </div>
        </div>
  ...
  },
  {
    ...
    emoji: '💡',
    color: '#eab308',
    content: 'Smart shoppers choose Brandstored. Get more for less!',
    cta: 'Shop Smart',
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          <p style="font-size: 16px; line-height: 1.6; color: #374151; margin: 0 0 24px 0;">
            Smart shoppers choose Brandstored. Get more for less!
          </p>
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #eab308; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(234, 179, 8, 0.3);">
              Shop Smart
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #6366f1; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(99, 102, 241, 0.3);">
              See Products
            </a>
          </div>
        </div>
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 40px 30px; background: #f9fafb;">
          ...
          ${generateProductGrid(products)}
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com'}" style="display: inline-block; background: #f59e0b; color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(245, 158, 11, 0.3);">
              Shop Deals
            </a>
          </div>
        </div>
  ...
  {
    id: 'love-Brandstored',
    subject: 'Brandstored Finds You\'ll Love ❤️',
    title: 'Brandstored Finds',
    ...
    template: (products = [], recipientEmail = '') => `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
        <div style="background: linear-gradient(135deg, #f43f5e 0%, #e11d48 100%); padding: 40px 20px; text-align: center; color: #ffffff;">
          <h1 style="font-size: 42px; margin: 0 0 10px 0;">❤️</h1>
          <h2 style="margin: 0; font-size: 28px; font-weight: 700;">Brandstored Finds You'll Love</h2>
...
function generateProductGrid(products = []) {
  ...
  const currency = 'AED';
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://brandstored.com';
    ...
    <div style="background: linear-gradient(180deg, #0f172a 0%, #1a202c 100%); padding: 40px 30px; text-align: center; color: #cbd5e1;">
      <div style="margin-bottom: 20px;">
        <div style="display: inline-block; background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 10px 16px; border-radius: 8px; margin-bottom: 12px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
          <span style="font-size: 26px; font-weight: 800; color: #ffffff; letter-spacing: 0.5px;">⚡ Brandstored</span>
        </div>
      ...
      <p style="margin: 16px 0 8px 0; font-size: 13px; color: #94a3b8;">© ${new Date().getFullYear()} Brandstored. All rights reserved. 🔐</p>
      <p style="margin: 0 0 16px 0; font-size: 12px;">
        ...
        <a href="${baseUrl}/profile/settings" style="color: #cbd5e1; text-decoration: none; font-weight: 600;">⚙️ Preferences</a>
      </p>
      
      <div style="border-top: 1px solid #334155; padding-top: 12px; margin-top: 12px;">
        <p style="margin: 0 0 8px 0; font-size: 11px; color: #64748b;">You received this email because you have an account with Brandstored.</p>
